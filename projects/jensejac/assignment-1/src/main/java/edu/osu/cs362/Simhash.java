...
public class Simhash {
	...
	public int hammingDistance(int hash1, int hash2) { // this function now has the bug:
		int i = hash1 ^ hash2;	// all shift operators are arithmetic instead of logical
		i = i - ((i >> 1) & 0x55555555);
	...
	public int hammingDistance(long hash1, long hash2) { // same bug in this one
		long i = hash1 ^ hash2;
